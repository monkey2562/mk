...
import com.mk.security.ui.LockActivity;
...
public class WatchDogService extends Service {
    ...
    public void onCreate() {
        ...
        //注册一个内容观察者
        getContentResolver().registerContentObserver(Uri.parse("content://com.xiaobin.security.applockprovider"), true, new MyObserver(new Handler()));
            ...
            public void run() {
                while (flag) {
                    try {
                        ...
                        Log.v(MkUtils.TAG, "当前在运行：" + packageName);
