...
import com.mk.security.receiver.ProcessClearReceiver;
...
public class UpdateWidgetService extends Service {
    ...
    public void onCreate() {
        ...
        // 拿到一个ComponentName对象
        componentName = new ComponentName("com.mk.security", "com.mk.security.receiver.ProcessWidget");
        // 就是显示到桌面上的界面啦，所有布局是我们写的那个widget的布局
        remoteViews = new RemoteViews("com.mk.security", R.layout.process_widget);
