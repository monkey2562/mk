package com.mk.security.provider;
...
public class AppLockProvider extends ContentProvider {
    ...
    static {
        matcher.addURI("com.mk.security.applockprovider", "insert", INSERT);
        matcher.addURI("com.mk.security.applockprovider", "delete", DELETE);
    }

    public AppLockProvider() {
    }
